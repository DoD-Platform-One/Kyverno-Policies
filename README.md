...
![Version: 3.2.5-bb.7](https://img.shields.io/badge/Version-3.2.5--bb.7-informational?style=flat-square) ![AppVersion: v1.12.5](https://img.shields.io/badge/AppVersion-v1.12.5-informational?style=flat-square)
...
| waitJob.scripts.image | string | `"registry1.dso.mil/ironbank/opensource/kubernetes/kubectl:v1.29.7"` |  |
